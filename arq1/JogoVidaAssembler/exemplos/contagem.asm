...
laco:    mov ah,3fh      ; le um caractere do aqruivo
         ...
         jne fim         ; n&atilde;o - encontrou fim de arquivo
...
escrever:
; fim do c&aacute;lculo de contagens para fins de estatisticas

         mov dl, caractere  ; escreve caractere na tela
         mov ah,2
         int 21h
;         
         mov dl, caractere  ; escreve na tela at&eacute; encontrar um LF (fim de linha)
         cmp dl, LF
         jne laco
;   
...
; fim da exibi&ccedil;&atilde;o da mensagem com as estatisticas
;      
